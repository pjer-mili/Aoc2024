...
def main():
    ...
    start, end = (0, 0), (70, 70)
    find_first_blocking_position(start, end, grid, corrupted, 13)
...
def find_first_blocking_position(start, end, grid, corrupted_positions, start_from_idx):
    subset = corrupted_positions[start_from_idx:]
    for block in subset:
